...
import { generateToken, auth } from './middlewares/auth'
import { createEmployee, applyToJob } from './service/employee.service'
import { registerShop, getShop, verifyShop, getShopDetails, createJobPost, setEmployeeAcceptStatus, getApplicants, resetPassword } from './service/shopkeeper.service'
import { SignUpReq, RegisterShopReq, UuidQueryParam, CreateJobReq, ApplyJob, JobIdQ } from './utils/req.zod'
...
app.use('/api/heath-check', (_req, res) => {
